    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="mt-16 text-center text-slate-400 animate-slide-up-fade" style={{animationDelay: '0.6s'}}>
          <p className="mb-4">
            You can also reach us on our <a href="https://discord.gg/qYQAVmzJEC" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:text-purple-300 underline">Discord support server</a>
          </p>
        </div>
      </div>
